...
const AudioPlayer: FC<AudioPlayerProps> = (({ routerPath }) => {
	...
	useEffect(() => {
		return () => { setPrevPath(router.asPath.split(/[/]|[#]/)[1]) }
	}, [router]);
	...
	return (
		<div className={
			cn(
				styles.audio,
				play ? styles.audio_active : '',
				routerPath === 'sleeping' ?
					styles.audio_sleeping :
					routerPath === 'awake' ? styles.audio_awake :
						styles.audio_terminal,
			)}
			onClick={soundAction}
		>
			{!play ? <svg width="32" height="32" fill="none" viewBox="0 0 32 32">
				<path d="M1.99999 21L1.99999 11L6.49999 11L15 6L15 26L6.49999 21L1.99999 21Z" stroke="white" />
				...
				<svg width="32" height="32" fill="none" viewBox="0 0 32 32">
					<path d="M1.99999 21L1.99999 11L6.49999 11L15 6L15 26L6.49999 21L1.99999 21Z" stroke="white" />
					<path d="M22.5922 27.0862C24.0481 26.4831 25.371 25.5992 26.4853 24.4849C27.5996 23.3706 28.4835 22.0477 29.0866 20.5918C29.6896 19.1359 30 17.5755 30 15.9996C30 14.4238 29.6896 12.8633 29.0866 11.4074C28.4835 9.95153 27.5996 8.62866 26.4853 7.51436C25.371 6.40006 24.0481 5.51614 22.5922 4.91309" stroke="white" />
					<path d="M20.2961 21.5436C21.0241 21.2421 21.6855 20.8001 22.2426 20.2429C22.7998 19.6858 23.2417 19.0244 23.5433 18.2964C23.8448 17.5685 24 16.7882 24 16.0003C24 15.2124 23.8448 14.4322 23.5433 13.7042C23.2417 12.9763 22.7998 12.3148 22.2426 11.7577C21.6855 11.2005 21.0241 10.7586 20.2961 10.457" stroke="white" />
				</svg>
			}
		</div>
	)
